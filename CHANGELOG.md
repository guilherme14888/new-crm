...
* **acl:** resolveScope ignora ?company=all (corrige monitor 'sem execucao') ([c3c6e91](https://github.com/guilherme14888/new-crm/commit/c3c6e91f974db5e2109603b4e8c3099ff2330801))
* agendador de ingestao auto-recuperavel (rede de seguranca a cada 30min) ([843089c](https://github.com/guilherme14888/new-crm/commit/843089c704e0365347e0194cd4614da0b63c44fd))
* **ai-config:** chave cifrada no banco (AES-GCM) + corrige mismatch de provedor ([bdd6416](https://github.com/guilherme14888/new-crm/commit/bdd6416a3eef0573cb23a8c9e6cf0b27c8e7a04f))
* **ai-config:** save a prova de confusao + 502 mostra erro real ([f0b1ab3](https://github.com/guilherme14888/new-crm/commit/f0b1ab3efa6036b6fd038467da00775c2778f06c))
* **ai:** chave de IA em texto puro (sem cifra) — elimina o 502 por mismatch de segredo ([d8dad99](https://github.com/guilherme14888/new-crm/commit/d8dad993dd41122c23d241170c596893341e9f27))
* **ai:** chave nao decifravel (502 opaco) — multi-segredo, fail-fast e status claro ([458676f](https://github.com/guilherme14888/new-crm/commit/458676f83b3ecfc8ca64b65982d1b11cbcaa41a3))
* **branding:** miniatura da Default a ESQUERDA + sem caixa branca (mescla na sidebar) ([d0c2b3b](https://github.com/guilherme14888/new-crm/commit/d0c2b3bfe5e49a8c2e4bb9f8e75212b07866a627))
* decodifica nome dos PDFs do zip em CP850 (acentos corretos) ([a5534c8](https://github.com/guilherme14888/new-crm/commit/a5534c85fa3ab0b32cd80f349a058a81876b2294))
* editar palavra-chave re-sincroniza o rotulo (produto_candidato) das licitacoes ja capturadas ([e35d1c7](https://github.com/guilherme14888/new-crm/commit/e35d1c788d4624e4fdbae4675cf0224591ceff4d))
* filtros da Listagem como dropdown accordion (sem sobreposicao) e Dashboard mais rapido ([af3f0fc](https://github.com/guilherme14888/new-crm/commit/af3f0fcc200cf0cafa00c78eabdc0007a0a64e9a))
* **ingest:** corrige relevancia com provedor configuravel (MODEL removido) ([6342b21](https://github.com/guilherme14888/new-crm/commit/6342b21d16c9ea0d26068fc27bbafc39870a4e06))
* **ingest:** evita compounding de retry de 429 na enumeracao do sweep ([f14514f](https://github.com/guilherme14888/new-crm/commit/f14514f16312dafc9ad67c2c8a619e9ef14cf1c3))
* **ingest:** varredura PNCP resiliente a 429 (sem truncamento silencioso) ([7e0c5d6](https://github.com/guilherme14888/new-crm/commit/7e0c5d6f89a4e865e4be3343c84b617b729f9053))
* **kanban:** lazy-load 10-em-10 deterministico (corta os DADOS, nao so a renderizacao) ([b73210f](https://github.com/guilherme14888/new-crm/commit/b73210f97cb500edc442ef90f7a59e74732d6058))
* mapa do Brasil com geometria real por UF (sem cor) + KPIs com valor inteiro ([7078306](https://github.com/guilherme14888/new-crm/commit/70783069b3768ecc2e36ebb0850e853e6bf4f9f7))
* **market-intel:** remove o logo BR4 do cabecalho do dashboard ([a30af53](https://github.com/guilherme14888/new-crm/commit/a30af5370e541e20a075c1c4e1343c252ea133b1))
* **market-intel:** trunca nome longo no filtro Empresa do dashboard (...) ([ea108ff](https://github.com/guilherme14888/new-crm/commit/ea108ff55842b4e379a15dac5a3a66bdae6f3f0f))
* matchesTerm mais preciso em keywords multi-palavra ([1cccd05](https://github.com/guilherme14888/new-crm/commit/1cccd0562b190c6a74b6bdb6f7639072e1a40af1))
* **mining-history:** seletor de tenant persiste na Default ao escolher empresa ([d280573](https://github.com/guilherme14888/new-crm/commit/d280573bb1811d892db67b0ead3ed794e20a0f84))
* rotulos das UFs no centro real do estado (centroide de area) ([6666b3c](https://github.com/guilherme14888/new-crm/commit/6666b3c5480530620fe7ba613ac1271995b9b2c6))
* rotulos do NE com linha-guia no mapa + calendario abre ao clicar nos filtros de data ([91edc91](https://github.com/guilherme14888/new-crm/commit/91edc91333d3fa645e199f3a54beced3dff261ab))
* **security:** corrige cross-tenant em deals e bug 500 em users; hardening ([323fcc7](https://github.com/guilherme14888/new-crm/commit/323fcc723665d2a8467a5f7b3610fe919e142850))
* setas de ordenacao visiveis em todas as colunas da Listagem ([57098a2](https://github.com/guilherme14888/new-crm/commit/57098a26cb2b8b233dbfa13ce129b00591acf1de))
* **sidebar:** publica ajustes do botao de recolher (chevron sem circulo, cor da fonte) ([dc814ba](https://github.com/guilherme14888/new-crm/commit/dc814ba3dbd39ac9a14c7037d6e97aac9e7bd8eb))
* sincroniza enum role ao escolher perfil ACL na edicao de usuario ([5781ce2](https://github.com/guilherme14888/new-crm/commit/5781ce222313b43e1c9c1ff2a1a723113f353944))
* worker de ingestao responde /health (Swarm matava o worker em loop) ([9523405](https://github.com/guilherme14888/new-crm/commit/95234059bf615c1408f75f264a0150e44284f69f))


### Features

* **acl:** enforcement fase 2 — companies/billing/trial e leads_* ([aeb167d](https://github.com/guilherme14888/new-crm/commit/aeb167dfa696b8136fdf2bb81a297d03a9f18913))
* **acl:** Historico de Mineracao travado ate admins de filha via ACL ([935e0ae](https://github.com/guilherme14888/new-crm/commit/935e0ae7ba7355c3064e4dd6080fa6792f146e84))
* **acl:** liga o enforcement das permissoes (requirePermission, fail-safe) ([073b7e8](https://github.com/guilherme14888/new-crm/commit/073b7e8f860d1fcee533d4a462058d732c07ebff))
* **branding:** logo por empresa na sidebar + miniatura da Default sobreposta ([ba74e62](https://github.com/guilherme14888/new-crm/commit/ba74e62ab492654e379beab6fc99d3d0be12d96e))
* card de oportunidades aguardando participacao + auto-Perdido ([c891eb0](https://github.com/guilherme14888/new-crm/commit/c891eb0cf26b99393a824df8e959ec13d70e4d57))
* clique no legend isola o produto no grafico mensal (solo/reverter) ([d48291e](https://github.com/guilherme14888/new-crm/commit/d48291e82e96c2423be14f4ae2aa1c269cf70a52))
* **coleta:** 2Captcha (BEC-SP), catalogo com 42 portais (login) e Compras-CE all ([f42e01b](https://github.com/guilherme14888/new-crm/commit/f42e01bd3568ea99c8f789b2528c9524e707a549))
* **deal-files:** edital/ata do PNCP na aba Arquivos + categoria, nome e link no anexar ([2893e45](https://github.com/guilherme14888/new-crm/commit/2893e4529736ed3a8544939d17138f8b12ba25cc))
* **deploy:** stack 4 servicos pronto p/ Portainer (dados reais BR4) ([1a41078](https://github.com/guilherme14888/new-crm/commit/1a41078a35e202892ba2a6f24366e0fc52d2723f))
* dockerização, CI de release e listagem de inteligência de mercado ([c5a04b5](https://github.com/guilherme14888/new-crm/commit/c5a04b51745cbde5726bb07293a8b4f9878f858b))
* Financeiro dividido (Default x tenant) + visibilidade de menus por perfil ([bd3f0b1](https://github.com/guilherme14888/new-crm/commit/bd3f0b11c3f080ccf892140d2a48ce6705c9d822))
* IA global (Default-only), expansao do ACL e periodo de teste por tenant ([40d9841](https://github.com/guilherme14888/new-crm/commit/40d98410fa85e5a58b77a440d4b20b5d5f5f35f4))
* **ingest:** circuit breaker + cooldown persistido para nunca penalizar no PNCP ([285b154](https://github.com/guilherme14888/new-crm/commit/285b154ca3c37f81722fda009a6e9f7fcca16426))
* **ingest:** Compras.gov como failover do PNCP + cooldown ciente de host ([2a41f26](https://github.com/guilherme14888/new-crm/commit/2a41f26769b33b328351eeb09122a8daab9b6bc0))
* **ingest:** conector Compras-CE (TCE-CE) dirigido por configuracao ([d540979](https://github.com/guilherme14888/new-crm/commit/d5409793a7200439b3c3d8403f89a9d78f689d6e))
* **ingest:** conector Compras-ES (SIGA) — primeiro do subconjunto de dados abertos ([39cd3bb](https://github.com/guilherme14888/new-crm/commit/39cd3bb726d4e2f449d7844efde99cc7582f6ce0))
* **ingest:** sync automatico de oportunidades apos cada ingestao ([6559c7c](https://github.com/guilherme14888/new-crm/commit/6559c7cc8d0f9f2135f9ed750ffe777a56a9bcae))
* **ingest:** varredura completa do PNCP (cobertura garantida) + auditoria ([d5ea522](https://github.com/guilherme14888/new-crm/commit/d5ea522b265fee8e2457364a488c83e89b3e710a))
* **kanban:** produto no card de Oportunidade + lazy-load (10 em 10) nos kanbans ([75231ef](https://github.com/guilherme14888/new-crm/commit/75231ef4a0f9050d166d004d5b26ae841d26fd16))
* legenda clicavel filtra produtos no grafico mensal (visao executiva) ([16cf673](https://github.com/guilherme14888/new-crm/commit/16cf6739a08d7bce4abbbcfb3511ef56cd124013))
* leitor de documentos extrai todos os PDFs (zips aninhados) e lista por arquivo ([f8b904f](https://github.com/guilherme14888/new-crm/commit/f8b904fdbb50381754ff4a4ff8fc2f102cfe6c01))
* leitor de edital/ata (PDF) embutido na Listagem ([1e5d5fa](https://github.com/guilherme14888/new-crm/commit/1e5d5fac96991b2b1bdfc87e0fea51433ea0fe3a))
* mapa de IM com drill-down por estado + bolinhas na coordenada da cidade ([dfbfda8](https://github.com/guilherme14888/new-crm/commit/dfbfda81c7fab96ebed091e9ee3d6b4cdcf4c845))
* **market-intel:** expoe a origem (fonte) de cada licitacao na Listagem ([0b25687](https://github.com/guilherme14888/new-crm/commit/0b2568737e885bb8555570d0aa8a39885dbc38e2))
* **market-intel:** filtros unificados num drawer (Visao Executiva) ([8bef8f1](https://github.com/guilherme14888/new-crm/commit/8bef8f1c29cc988689154dcc9f3f2e9986b301cd))
* **market-intel:** governanca de contexto das palavras-chave + assistente de IA ([bf96a83](https://github.com/guilherme14888/new-crm/commit/bf96a83ed70d630fde0cd901ab46129e38278dd6))
* **market-intel:** grafico 12m por padrao, Orgao multi, Empresa Concorrente, toggle todos/nenhum ([3611110](https://github.com/guilherme14888/new-crm/commit/3611110c49f4a1447101e70a98c0dde49c88d841))
* **market-intel:** Historico de Mineracao (dias x palavras-chave) com ACL ([f22cbf1](https://github.com/guilherme14888/new-crm/commit/f22cbf1f1af6cab06075777f1276f099b187c5eb))
* **market-intel:** IA com dropdowns + busca de modelos por chave + provedor Groq ([7fafaa2](https://github.com/guilherme14888/new-crm/commit/7fafaa2109f68fce0c7f3d8694b7c5d884433f27))
* **market-intel:** Listagem ordena por ingestao desc (mais novos primeiro) ([4476fc3](https://github.com/guilherme14888/new-crm/commit/4476fc316f1bb6a9e83fddd187a33329d3a4b299))
* **market-intel:** monitoria diaria no Historico de Mineracao ([e598350](https://github.com/guilherme14888/new-crm/commit/e598350d6cb5ab9c3172c75e9e0f0feca051b8d6))
* **market-intel:** painel de Cobertura / Saude da Coleta (monitoramento da varredura) ([64fd1ca](https://github.com/guilherme14888/new-crm/commit/64fd1ca041ef7009e5c038619467e791a92e1969))
* **market-intel:** provedor de IA configuravel na UI (Anthropic/OpenAI/Gemini/Grok/DeepSeek) ([067fead](https://github.com/guilherme14888/new-crm/commit/067fead9f036336a9361dd60c9941a866274a8bb))
* oportunidades abertas -> Licitacoes com confirmacao de participacao + docs no deal ([0327c0c](https://github.com/guilherme14888/new-crm/commit/0327c0c96c6dd3099617aae774208337a02fcc55))
* oportunidades como cards bloqueados na etapa Oportunidade + botao Participar ([5741066](https://github.com/guilherme14888/new-crm/commit/57410669af2b824bd419f9f42f5e6b88814c41f9))
* **opportunities:** grava desfecho da licitacao no deal Perdido (vencedor/valor/historico) ([0d3e98f](https://github.com/guilherme14888/new-crm/commit/0d3e98f17d267f6c4b2472ef37b7e427d7241df3))
* ordenacao por coluna na Listagem (clique no cabecalho alterna asc/desc) ([6643c2b](https://github.com/guilherme14888/new-crm/commit/6643c2b46d9fe245baf6c8088a1d9cde9e79c599))
* paginacao (20/pagina) na Listagem e dashboard de IA mais leve ([1bbaded](https://github.com/guilherme14888/new-crm/commit/1bbaded28211c7be45f26ee15f0ad3122207b855))
* papel (ACL) como lista suspensa e redefinicao de senha na edicao de usuario ([6cdf208](https://github.com/guilherme14888/new-crm/commit/6cdf2083a67fb3b5312aceb8eee777bd12e865e2))
* **scrape-worker:** esqueleto Playwright p/ portais sem API + adapter BEC-SP ([717eae0](https://github.com/guilherme14888/new-crm/commit/717eae03f8e6570c1a9d1491044e23c07a74c264))
* **scrape:** log diario de execucao por portal + percorre todos + remove mock ([d985be6](https://github.com/guilherme14888/new-crm/commit/d985be68d7a7d6a18a9f6f6e85077da13930abf5))
* **scrape:** robo generico (Playwright) entra em TODOS os portais ([7561186](https://github.com/guilherme14888/new-crm/commit/7561186b7db92e0b99b7628122128965281d6347))
* scraping objetivo (so itens da keyword) + historico da licitacao ([a83adc9](https://github.com/guilherme14888/new-crm/commit/a83adc933940ff333d42550c2c3a175fb095d31e))
* **settings:** chave 2Captcha cadastravel na UI (global, cifrada) ([8777f9e](https://github.com/guilherme14888/new-crm/commit/8777f9e3f7e66c8b645fd26a4abaf875d2708f65))
* **sidebar:** troca de empresa so p/ usuarios da Default + Default 1o + Config por ultimo ([9edbb4c](https://github.com/guilherme14888/new-crm/commit/9edbb4c1e6425fc166b3ff6d3ee05c437ba81ef3))
* **teams:** atribuir Tenants por Equipe — visualizacao restrita na Default ([bb74fbd](https://github.com/guilherme14888/new-crm/commit/bb74fbd8a7f4cc2ee10a1501bafc9d8d7469f61e))
* **theme:** tema (cores) personalizavel por tenant — sidebar + sistema ([40a4097](https://github.com/guilherme14888/new-crm/commit/40a409727ef94787394324e1d873750e693fa8f2))
* **ui:** redesign NextAdmin - fase 1: paleta + tokens + cards/inputs + canvas ([f01ede5](https://github.com/guilherme14888/new-crm/commit/f01ede5fb8430fa34a50d277d395c879faedc7be)), closes [#3C50E0](https://github.com/guilherme14888/new-crm/issues/3C50E0) [#1C2434](https://github.com/guilherme14888/new-crm/issues/1C2434) [#E2E8F0](https://github.com/guilherme14888/new-crm/issues/E2E8F0) [#F1F5F9](https://github.com/guilherme14888/new-crm/issues/F1F5F9)
* **ui:** redesign NextAdmin - fase 1b: botoes (cursor/hover web) + avatar (paleta) ([59b1495](https://github.com/guilherme14888/new-crm/commit/59b14954832d870abfab069e6795b28a0392549a))
* visao executiva no dashboard (KPIs, valor por licitador) + mapa do Brasil ([62b1f2c](https://github.com/guilherme14888/new-crm/commit/62b1f2ce2f1da8568507ea78efccc587faaca951))
* worker isolado de ingestao (servico separado no swarm) ([12c1645](https://github.com/guilherme14888/new-crm/commit/12c16454a93261220067af77b056ac7fe088ae7b))


### Performance Improvements

* **db:** indices compostos por tenant (migration 034) + pool dimensionado ([7ed9d8b](https://github.com/guilherme14888/new-crm/commit/7ed9d8bce17ec4e7ec5e4b5a713564c8d98d9820))
* **db:** tuning de indices + collation (migration 037) ([e6795ea](https://github.com/guilherme14888/new-crm/commit/e6795eab85f4f49dfcd37f00838496ccc9285cf0))
* **front:** debounce na busca + blob pre-computado + cap no MultiSelect ([50af3b1](https://github.com/guilherme14888/new-crm/commit/50af3b10e3f38a87fa67e2a1a8161ed11ca2335c))
* **ingest:** throttle global+429, bulk upsert e enumeracao 1x do PNCP ([ca952bf](https://github.com/guilherme14888/new-crm/commit/ca952bfd1ad5f366cfd11160f3e1985da16f9479))

## [1.48.1](https://github.com/guilherme14888/crm-br4/compare/v1.48.0...v1.48.1) (2026-06-22)


### Bug Fixes

* **sidebar:** publica ajustes do botao de recolher (chevron sem circulo, cor da fonte) ([dc814ba](https://github.com/guilherme14888/crm-br4/commit/dc814ba3dbd39ac9a14c7037d6e97aac9e7bd8eb))
...
* **branding:** logo por empresa na sidebar + miniatura da Default sobreposta ([ba74e62](https://github.com/guilherme14888/crm-br4/commit/ba74e62ab492654e379beab6fc99d3d0be12d96e))
